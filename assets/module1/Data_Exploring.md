...
Otras variables también parecen ser muy subjetivas, como *"ComeVegetales"* y *"ConsumoDeAgua"*, porque el conjunto de datos no especifica si los números contenidos en ambas variables tienen una unidad de medida, por lo tanto parece correcto tratarlos como un consumo relativo, pero sería de gran ayuda si se especificara si los números son frecuencia semanal, litros, galones o cualquier otra unidad.
